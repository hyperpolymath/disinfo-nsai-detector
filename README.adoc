...
:experimental:
:url-github: https://github.com/hyperpolymath/disinfo-nsai-detector
:url-gitlab: https://gitlab.com/hyperpolymath/disinfo-nsai-detector
:url-bitbucket: https://bitbucket.org/hyperpolymath/disinfo-nsai-detector
:url-codeberg: https://codeberg.org/hyperpolymath/disinfo-nsai-detector

Disinformation and AI-generated content detection
...
disinfo-nsai-detector is part of the link:https://rhodium.sh[Rhodium Standard] (RSR) ecosystem.
